...
namespace Outlander.Demo.LanguageDefinitions
{
    public class OutlanderRazorLanguageDefinition : ILanguageDefinition
    {
        ...
        static OutlanderRazorLanguageDefinition()
        {
            ...
            var razorAndHtmlRules = new List<TokenRule>
            {
                ...
                new("@bind-([A-Z][a-zA-Z0-9]*)(?::[A-Za-z]+)?", PrioRazorTransitionAndBlock - 5, "razor transition", null),
